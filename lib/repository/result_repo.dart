...
class ResultRepo {
  static Future getAllResultsAPI(
      {int eventType, int eventGradeId, int eventStage}) async {
    print(
        "${AppConfig.apiBaseUrl}/results?event_type=$eventType&event_stage=$eventStage&event_grade=$eventGradeId");
    try {
